...
public class EJB3RemoteBusinessInterface_EAP5toEAP6_EAPGroup2ManagedTest extends TimeoutTestCase {
  ...
  public static EnterpriseArchive createDep2() {
    JavaArchive jar = ShrinkWrap.create(JavaArchive.class, CLIENT_MODULE_NAME + ".jar")
        ...
        .addClass(EJB3RemoteBusinessInterface_EAP5toEAP6_EAPGroup2ManagedTest.class)
...
//      return client;
  ...
  public void testInvokeStateless() throws Exception {
    String string = "" + System.currentTimeMillis();
    String jndiName = NAME + "/" + StatelessRemoteBusinessInterface.class.getSimpleName() + "Bean/remote";
    jndiName = "jboss/exported/" + NAME + "/" + MODULE_NAME +	"/StatelessRemoteBusinessInterfaceBean!org.jboss.tests.ejb3.interfaces.StatelessRemoteBusinessInterface";
  ...
  private <T> T lookupEJBObject(String jndiName, Class <T> interfaceClass) throws NamingException {
    ...
    props.put(Context.PROVIDER_URL, "jnp://127.0.0.1:5599");
